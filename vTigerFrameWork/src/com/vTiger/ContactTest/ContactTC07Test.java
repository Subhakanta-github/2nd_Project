...
public class ContactTC07Test extends BaseClass {
...
String Title=flib.getExcelData("Sheet1", 12, 3);


WebElement c4=driver.findElement(By.name("search_text"));//Search Box
c4.sendKeys(Title);
WebElement w4=driver.findElement(By.id("bas_searchfield"));//Dropdown
Select selt4=new Select(w4);
selt4.selectByVisibleText("Title");


driver.findElement(By.name("submit")).click();

boolean disLTitle=driver.findElement(By.xpath("//td[text()='lead ']")).isDisplayed();
Assert.assertTrue(disLTitle);
c4.clear();
	}
