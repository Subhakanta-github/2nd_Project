...
public class ContactTC10 extends BaseClass{
...
String officePhonetest=flib.getExcelData("Sheet1", 18, 3);

WebElement c7=driver.findElement(By.name("search_text"));//Search Box
c7.sendKeys(officePhonetest);
WebElement w7=driver.findElement(By.id("bas_searchfield"));//Dropdown
Select selt7=new Select(w7);
selt7.selectByVisibleText("Office Phone");
driver.findElement(By.name("submit")).click();

boolean disContact=driver.findElement(By.xpath("//td[text()='1234567890 ']")).isDisplayed();
